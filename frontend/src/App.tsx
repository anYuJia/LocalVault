...
export default function App() {
  ...
  useEffect(() => {
    ...
    void listenEvent<{ event?: string; cookie_set?: boolean; sec_uid?: string; nickname?: string }>("cookie-login-status", (payload) => {
    ...
    const handleCookieLoginDomStatus = (event: Event) => {
      handleCookieLoginStatus((event as CustomEvent<{ event?: string; cookie_set?: boolean; sec_uid?: string; nickname?: string }>).detail || {});
    };
